  ...
  <div class="Producto">
    ...
    <div class="contenidoUsuario">
      <ul class="columnasEditar">
        ...
        <li class="filaseditar filachild"><a href="PiqueosC.php" class="link_perfil">Piqueos</a></li>
      ...
      <div class="contenidoUsuario_all">
        <div class="wrapper">
          ...
          $query = mysqli_query($conexion, "SELECT a.cod_pro,a.producto,a.Descripcion,a.precio,a.stock,c.categoria,p.tamaño,a.imagen from producto a INNER JOIN categoria c ON a.idcategoria=c.idcategoria INNER join porcion p on a.idporcion=p.idporcion WHERE categoria='Pizza'  ");
