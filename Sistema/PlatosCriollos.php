...
<!-- MENU -->
    ...
    <div class="contenidoUsuario">
            <ul class="columnasEditar">
                ...
                <li class="filaseditar filafirst"><p class="firstEditar">Platos Criollos</p></li>
      ...
      $query = $conexion->prepare("SELECT a.cod_pro,a.producto,a.Descripcion,a.precio,a.stock,c.categoria,p.tamaño,a.imagen from producto a INNER JOIN categoria c ON a.idcategoria=c.idcategoria INNER join porcion p on a.idporcion=p.idporcion WHERE categoria='Platos Criollos'");
      $query -> execute();
