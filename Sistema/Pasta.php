...
<!-- MENU -->
    ...
    <div class="contenidoUsuario">
            <ul class="columnasEditar">
                <li class="filaseditar filachild"><a href="MenuU.php" class="link_perfil">Pizzas</a></li>
                <li class="filaseditar filafirst"><p class="firstEditar">Pasta</p></li>
                <li class="filaseditar filachild"><a href="Piqueos.php" class="link_perfil">Piqueos</a></li>
       ...
       $query = $conexion->prepare("SELECT a.cod_pro,a.producto,a.Descripcion,a.precio,a.stock,c.categoria,p.tamaño,a.imagen from producto a INNER JOIN categoria c ON a.idcategoria=c.idcategoria INNER join porcion p on a.idporcion=p.idporcion WHERE categoria='Pasta' ");
       $query -> execute();
