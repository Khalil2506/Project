    ...
    <div class="contenidoUsuario">
      ...
      <div class="contenidoUsuario_all">
        <div class="wrapper">
          ...
          $query = $conexion->prepare("SELECT a.cod_pro,a.producto,a.Descripcion,a.precio,a.stock,c.categoria,p.tamaño,a.imagen from producto a INNER JOIN categoria c ON a.idcategoria=c.idcategoria INNER join porcion p on a.idporcion=p.idporcion WHERE categoria='Pizza'  ");
          $query->execute();
          ...
          <?php foreach ($listaProducto as $data) { ?>
            <div id="carta" class="item">
              ...
              <div class="cont_pro">
                ...
                <div class="Seleccion_tamaño">
                  <p class="p pro_tamaño"><?php echo $data['tamaño'] ?></p>
